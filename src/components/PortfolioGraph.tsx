...
import { VictoryCursorContainer, VictoryArea, VictoryChart, VictoryZoomContainer, VictoryLine, VictoryAxis, VictoryBrushContainer } from 'victory';
        ...
        <VictoryChart width={600} height={470} scale={{ x: "time" }}
          containerComponent={
            <VictoryCursorContainer
                cursorDimension="x"
                cursorLabel={datum => {return `${Math.round(datum.y)}`}}
                cursorLabelOffset={{ x: 20, y: -70 }}
            />
          }
        >
            <VictoryArea
